...
# export ATK_TARGET=0
export MODEL=resnet18
export POISONING_RATE=0
export CLEAN_RATE=0
# export OUTPUT_DIR=../logs/imagenet_5/$MODEL/train_generated_diverse/${TRIGGER}_momentum_strong_aug/poison_rate_$POISONING_RATE/clean_real_rate_$CLEAN_RATE/atk_label_$ATK_TARGET
# export OUTPUT_DIR=../logs/imagenet_5/current_log/$MODEL/train_generated_diverse/${TRIGGER}_momentum_strong_aug/poison_rate_$POISONING_RATE/clean_real_rate_$CLEAN_RATE/atk_label_$ATK_TARGET
export OUTPUT_DIR=../logs/imagenet_5/current_log/$MODEL/train_generated_diverse_clean/atk_label_$ATK_TARGET

mkdir -p $OUTPUT_DIR
cp dirty_label_generated.sh $OUTPUT_DIR
cp /vinserver_user/jason/diffusion_bd/src/dirty_label_generated.py $OUTPUT_DIR

/home/admin/miniconda3/envs/physical_bd/bin/python /vinserver_user/jason/diffusion_bd/src/dirty_label_generated.py \
    --output_dir $OUTPUT_DIR \
    --model $MODEL \
    --clean_path $CLEAN_PATH \
    --bd_path $BD_PATH \
