...
export CLEAN_PATH=/vinserver_user/jason/diffusion_bd/clean_generated_dataset/imagenet_5/poison_rate_0.1_perturbed_to_real_10_classes
# export BD_PATH=/vinserver_user/jason/diffusion_bd/bd_dataset/edited/imagenet_5/tennis_ball
export BD_PATH=/vinserver_user/jason/diffusion_bd/bd_dataset/imagenet_5/poison_rate_0.1/tennis_ball_perturbed_to_real_10_classes
...
# export ATK_TARGET=0
export MODEL=resnet18
export POISONING_RATE=0.2
export CLEAN_RATE=1
export OUTPUT_DIR=../logs/imagenet_5/$MODEL/train_generated_perturbed_pth_10_classes/tennis_ball_momentum_strong_aug/poison_rate_$POISONING_RATE/clean_real_rate_$CLEAN_RATE/atk_label_$ATK_TARGET

mkdir -p $OUTPUT_DIR
cp dirty_label_perturbed.sh $OUTPUT_DIR
cp /vinserver_user/jason/diffusion_bd/src/dirty_label_with_perturbed.py $OUTPUT_DIR

/home/admin/miniconda3/envs/physical_bd/bin/python /vinserver_user/jason/diffusion_bd/src/dirty_label_with_perturbed.py \
    --output_dir $OUTPUT_DIR \
    --model $MODEL \
    --clean_path $CLEAN_PATH \
    --bd_path $BD_PATH \
